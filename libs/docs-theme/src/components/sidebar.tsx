...
const classes = {
  ...
  active: cn(
    'nx-bg-black nx-font-semibold text-white dark:nx-bg-primary-400/10',
          ...
          {anchors.map(({ id, value }) => (
            <li key={id}>
              <a
                ...
                className={cn(
                  classes.link,
                  'nx-flex nx-gap-1.5 before:nx-opacity-25 before:nx-content-["#"]',
        ...
        {hasMenu && (
          <div
            className={cn(
              ...
              'nx-mx-4 nx-py-4',
              'nx-flex nx-items-center nx-gap-1.5',
