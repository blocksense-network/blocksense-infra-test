...
pub async fn validate(
    ...
    let safe_transaction = create_safe_tx(contract_address, calldata.clone(), nonce);
    ...
    if tx_hash_str != batch.tx_hash {
        ...
        anyhow::bail!(
            "tx_hash mismatch, block_height = {block_height}; recvd: {} generated: {}; calc_calldata = {calldata}; recvd_calldata = {recvd_calldata}",
            batch.tx_hash,
            tx_hash_str
        );
    }
