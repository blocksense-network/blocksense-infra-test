...
pub struct Provider {
    ...
    pub data_feed_store_byte_code: String,
    pub data_feed_sports_byte_code: String,
}
    ...
    SequencerConfig {
        ...
        providers: HashMap::from([(
            ...
            Provider {
                ...
                data_feed_store_byte_code: "".to_string(),
    ...
    for (network, private_key_path, url) in provider_details {
        ...
        providers.insert(
            ...
            Provider {
                ...
                event_contract_address: None,
                transcation_timeout_secs: 50,
                data_feed_store_byte_code: "".to_string(),
                data_feed_sports_byte_code: "".to_string(),
            },
        );
    }
