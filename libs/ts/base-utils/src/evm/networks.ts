...
const chainIds = [
  ...
  763373, 2358, 1285, 59144, 59141, 1952959480, 994873017, 169, 3441006, 5003,
  59902, 6342, 31611, 10143, 2818, 2810, 10, 11155420, 5611, 7849306, 137,
  80002, 1101, 2442, 57000, 200018, 31, 534352, 534351, 11011, 50312, 16, 57054,
  1660990954, 167000, 167009, 842, 41, 324, 300, 4801,
] as const;
