...
import {ICLFeedRegistryAdapterExp} from '../../../experiments/interfaces/ICLFeedRegistryAdapterExp.sol';
import {IChainlinkAggregator} from '../../../interfaces/chainlink/IChainlinkAggregator.sol';

contract RegistryExp {
  ICLFeedRegistryAdapterExp public immutable registry;
  ...
  constructor(address _registry) {
    registry = ICLFeedRegistryAdapterExp(_registry);
  }
