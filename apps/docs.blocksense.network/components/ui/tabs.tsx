...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      'inline-flex h-10 items-center justify-center rounded-md bg-muted p-1 dark:bg-neutral-900',
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Content
    ref={ref}
    className={cn(
      'tabs mt-2 px-2 py-2 shadow-md rounded-md bg-white border-solid dark:bg-neutral-900',
      className,
    )}
    {...props}
  />
