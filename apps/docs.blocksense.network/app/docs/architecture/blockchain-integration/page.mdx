...
<DiagramImageWrapper className="mt-6 dark:hidden" src="/diagrams/BlocksenseIntegration.png" alt="Blocksense Integration"/>
<DiagramImageWrapper className="mt-6 hidden dark:block" src="/diagrams/dark/BlocksenseIntegrationDark.png" alt="Blocksense Integration"/>
