...
See a complete list of available Hardhat commands and their descriptions in [package.json](https://github.com/blocksense-network/blocksense/blob/a7dc2c4976f6c8fee6a913616c29bf948d489bbc/libs/contracts/package.json).
