...
<Callout type="info">
  Use [ProxyCall library](https://github.com/blocksense-network/blocksense/tree/main/libs/contracts/contracts/libraries/ProxyCall.sol) for easy and gas optimised interaction with the contract.
</Callout>
